...
var createNewTaskElement=function(taskString){
    ...
    checkBox.className = "task-list__input--chkbox";
    editInput.type="text";
    ...
    deleteButtonImg.className = 'task-list__img--delete';
...
var taskCompleted=function(){
    ...
    this.parentNode.querySelector(".task-list__label").classList.add('task-list__label--compl');
...
//Mark task as incomplete.
    ...
    this.parentNode.querySelector(".task-list__label").classList.remove('task-list__label--compl');
    var listItem=this.parentNode;
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
